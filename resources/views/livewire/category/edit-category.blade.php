<div>
    <div class="p-4 border-gray-200 rounded-lg dark:border-gray-700 mt-14">
        <div
            ...
            <form class="max-w-2xl mx-auto" wire:submit="updateCategory">
                <div class="mb-5">
            ...
            @error('category_name') border-red-500 @else border-gray-300 @enderror"
                ...
                <div class="flex items-center space-x-2">
                    <button type="submit"
                    class="text-white bg-yellow-500 hover:bg-yellow-600 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Perbarui</button>
