                ...
                <div class="flex items-center mb-4 sm:mb-0">
                    <form class="sm:pr-3">
                        ...
                        <div class="relative w-48 mt-1 sm:w-64 xl:w-96">
                            <input type="search" wire:model.live="search" id="categories-search"
        ...
        <div class="overflow-x-auto">
            <div class="inline-block min-w-full align-middle">
                <div class="overflow-hidden shadow">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                            @forelse ($categories as $i=>$ctg)
                                <tr class="hover:bg-gray-100 dark:hover:bg-gray-700">
                                    ...
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $ctg->category_name }}</td>
                                    <td
                                        class="p-4 text-base font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        {{ $ctg->created_at }}</td>
                                    <td class="p-4 space-x-2 whitespace-nowrap">
                                        <a href="{{ route('edit-category', ['id' => $ctg->id]) }}" wire:navigate
                                        ...
                                        <button type="button" wire:click="deleteCategory({{ $ctg->id }})"
                    ...
                    <div
                        class="p-4 bg-white block border-b border-gray-200 lg:mt-0 dark:bg-gray-800 dark:border-gray-700">
